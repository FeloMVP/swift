...
const LoanCalculator: React.FC<LoanCalculatorProps> = ({ onApply }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100 max-w-md mx-auto">
      ...
      <div className="mb-6">
        <div className="flex justify-between mb-2">
          ...
          <span className="text-lg font-bold text-brand-700">KES {amount.toLocaleString()}</span>
        </div>
        <input 
          type="range" 
          min="500" 
      ...
      <div className="mb-8">
        <div className="flex justify-between mb-2">
          ...
          <span className="text-lg font-bold text-brand-700">{term} Days</span>
        </div>
        <input 
          type="range" 
          min="7" 
      ...
      {offer && (
        <div className="bg-brand-50 rounded-xl p-4 mb-6 space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-semibold text-gray-900">KES {(offer.totalRepayment - offer.amount).toLocaleString()}</span>
          </div>
          <div className="h-px bg-brand-200 my-2"></div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600 font-medium">Total to Repay</span>
      ...
      <button 
        ...
        className="w-full bg-brand-600 text-white py-4 rounded-xl font-bold hover:bg-brand-700 transition-colors shadow-lg shadow-brand-500/20 flex justify-center items-center"
      >
        Apply Now
